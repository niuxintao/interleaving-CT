...
Besides the works from combinatorial testing, there also exists code-based fault localization approach. As it , we just give some representative approaches .


From these works. Zeller's paper is. As it is the first one to . where our work shares similar idea with this work.


Additionally, the works of SPL is also very correlated to the Combinatorial testing.
