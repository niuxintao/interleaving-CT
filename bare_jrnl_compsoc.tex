...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The interesting exception is subject Tcas, on which \emph{ict} and \emph{sct} show a similar trend. This is because both \emph{ict} and \emph{sct} hardly  detect the high-degree MFS in Tcas, and consequently they are both transformed to normal covering arrays.
