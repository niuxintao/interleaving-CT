...
Similar to previous study, non-safe value do affect to approaches. And for the non-safe value, our approach \emph{ict} has a more clear advantage than the three approaches.
...
\textbf{Without assumptions, do affects the results of three approches, but our approach works the best among them.}
