...
{\color{blue}\subsection{The benifits of feedback checking mechanism}

In this section, we need to find how benififts of our feedback checking schemas. For this, we design the experiment as follows: ICT with feedback and ICT without feedback. And then show how they are work on the five experiments objects
...
Since our expeiemrment is based on single defect. Its appealing of how our approach work on multiple defects. For this, we adopt the following rules, distingusging failures. Our results is as follows:
...
\subsubsection{Result and discussion}
First, we list the subject information (parameter numbers, fault number and degrees), together with the corresponding strength of covering arrays that ELA needs to build, in Table 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
上午搞定
From this table, we can learn that , For subjects, it needs to .
...
\textbf{ ELA gets the best quality of the MFS, but needs much more test cases than our approach.  It also needs to know the number and degree of the MFS in prior, which limits its application in practice.}
